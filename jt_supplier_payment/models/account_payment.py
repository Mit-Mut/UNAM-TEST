...
class AccountPayment(models.Model):
    ...
    def action_register_payment(self):
        ...
        if not record_ids or any(invoice.payment_state != 'approved_payment' and (invoice.is_project_payment or invoice.is_payment_request or invoice.is_payroll_payment_request or invoice.is_different_payroll_request or invoice.is_pension_payment_request)  for invoice in record_ids):
