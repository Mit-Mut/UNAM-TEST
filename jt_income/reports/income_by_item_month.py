        ...
        for year in data_dict:
            ...
            for month in mont_dict:
                ...
                vals = {
                    ...
                    'enrollment_and_tuition' : month_dict.get('enrollment_and_tuition',0.0),
                    'selection_contest' : month_dict.get('selection_contest',0.0),
                    'incorporation_and_revalidation' : month_dict.get('incorporation_and_revalidation',0.0),
                    'extraordinary_income' : month_dict.get('extraordinary_income',0.0),
                    'patrimonial_income' : month_dict.get('patrimonial_income',0.0),
                    'financial_products' : month_dict.get('financial_products',0.0),
                    'nomina' : month_dict.get('nomina',0.0),
                    'suppliers' : month_dict.get('suppliers'),
                    'major_maintenance_fund' : month_dict.get('major_maintenance_fund',0.0),
                    'fif_funds' : month_dict.get('fif_funds',0.0),
