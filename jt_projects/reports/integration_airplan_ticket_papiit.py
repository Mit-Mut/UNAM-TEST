...
class IntegrationAirplaneTicket(models.AbstractModel):

    _name = "jt_projects.integration.airplane.ticket"
    _inherit = "account.coa.report"
    _description = "Integration airplane tickets PAPIIT"
    ...
    def _get_templates(self):
        templates = super(
            IntegrationAirplaneTicket, self)._get_templates()
        templates[
    ...
    def _get_report_name(self):
        return _("Integration airplane tickets PAPIIT")
    ...
    def get_pdf(self, options, minimal_layout=True):
        ...
        if minimal_layout:
            ...
            header = self.env['ir.actions.report'].render_template("jt_projects.external_integration_of_airplane_ticket_upi_papiit_projects", values=rcontext)
