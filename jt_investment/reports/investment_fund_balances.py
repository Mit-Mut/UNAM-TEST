...
class SummaryofOperationInvestmentFundsBalances(models.AbstractModel):
    _name = "jt_investment.summary.of.operation.investment.funds.balances"
    ...
    def _get_templates(self):
        templates = super(
            SummaryofOperationInvestmentFundsBalances, self)._get_templates()
        templates[
