...
class PayrollCheckAmounts(models.AbstractModel):

    _name = "jt_check_controls.amount_of_payroll_checks"
    _inherit = "account.coa.report"
    _description = "Reporting the amounts of payroll checks"
    ...
    def _get_templates(self):
        templates = super(
            PayrollCheckAmounts, self)._get_templates()
        templates[
    ...
    def _get_report_name(self):
        return _("Reporting the amounts of payroll checks")
