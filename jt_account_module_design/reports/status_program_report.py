...
class StatusProgramReport(models.AbstractModel):
    _name = "jt_account_module_design.status.program.report"
    _description = "Status Program Report"
    ...
    def _get_report_name(self):
        return _("Status Program Report")
    ...
    def _get_options_domain(self, options):
        # OVERRIDE
        domain = super(StatusProgramReport, self)._get_options_domain(options)
