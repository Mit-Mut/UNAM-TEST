...
class SummaryofOperationInvestmentFunds(models.AbstractModel):
    _name = "jt_investment.summary.of.operation.investment.funds"
    _inherit = "account.coa.report"
    _description = "Summary of Operation - Investment Funds"
    ...
    def _get_templates(self):
        templates = super(
            SummaryofOperationInvestmentFunds, self)._get_templates()
        templates[
    ...
    def _get_report_name(self):
        return _("Summary of Operation - Investment Funds")
    ...
    def get_pdf(self, options, minimal_layout=True):
        ...
        if minimal_layout:
            ...
            header = self.env['ir.actions.report'].render_template("jt_investment.external_layout_investment_funds", values=rcontext)
