...
class StatusOfActivities(models.AbstractModel):
    ...
    def _get_templates(self):
        templates = super(StatusOfActivities, self)._get_templates()
    ...
    def get_pdf(self, options, minimal_layout=True):
        ...
        if minimal_layout:
            ...
            header = self.env['ir.actions.report'].render_template("jt_conac.external_layout_of_status_activities", values=rcontext)
