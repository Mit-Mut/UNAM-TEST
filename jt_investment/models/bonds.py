...
class Bonds(models.Model):
    ...
    request_finance_ids = fields.One2many('request.open.balance.finance','bonds_id',copy=False)
    ...
    def unlink(self):
        ...
        return super(Bonds, self).unlink()
    ...
    def write(self, vals):
        res = super(Bonds, self).write(vals)
    ...
    def create(self,vals):
        ...
        res = super(Bonds,self).create(vals)
...
#         first_number = self.env['ir.sequence'].next_by_code('BONUS.number')
