...
#                         [('project_id', 'in', INFOCAB_ids.ids)])
    ...
    #                program_code_ids = INFOCAB_ids.mapped('program_code')
                    ...
                    lines.append({
                        ...
                        'columns': [
                            ...
                            self._format(
                                {'name': total_balance}, figure_type='float'),
                        ],
                        'level': 2,
                        'unfoldable': False,
                        'unfolded': True,
        ...
        lines.append({
            ...
            'columns': [
                    ...
                    self._format({'name': gt_total_balance},
                                 figure_type='float'),
            ],
            'level': 2,
            'unfoldable': False,
    ...
    def _get_report_name(self):
        return _("Integration of projects with budget resources")
    ...
    def get_xlsx(self, options, response=None):
        ...
        col += 1
        header_title = '''UNIVERSITY BOARD\nTREASURY\nGENERAL DIRECTORATE OF BUDGETARY CONTROL\nGENERAL ACCOUNTING\nRESEARCH PROJECT CONTROL DEPARTMENT\nREPORT ON CURRENT RESEARCH PROJECTS OF THE PAPIIT, PAPIME AND \n INFOCAB PROGRAMS'''
