...
#         ]
        ...
        for stage in stage_ids:
            for year in year_list:
                ...
                lines.append({
                        ...
                        'name' : 'SUBPROGRAMAS', 
                        'columns': [ 
                                    {'name': 'ASIGNADOS Y AUTHORIZADOS '+stage.name+"("+year+")"},
    ...
    def get_pdf(self, options, minimal_layout=True):
        ...
        if minimal_layout:
            ...
            header = self.env['ir.actions.report'].render_template("jt_projects.external_integration_of_upi_papiit_projects", values=rcontext)
