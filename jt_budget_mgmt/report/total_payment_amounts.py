...
class TotalPaymentAmounts(models.AbstractModel):
    _name = "jt_budget_mgmt.total.payment.amounts"
    _inherit = "account.coa.report"
    _description = "Total Payment Amounts"
    ...
    def _get_templates(self):
        templates = super(
            TotalPaymentAmounts, self)._get_templates()
        templates[
    ...
    def _get_report_name(self):
        return _("Total Payment Amounts")
...
#         y_offset += 1
    ...
    def get_pdf(self, options, minimal_layout=True):
        ...
        if minimal_layout:
            ...
            header = self.env['ir.actions.report'].render_template("jt_budget_mgmt.external_layout_total_payment_amounts", values=rcontext)
